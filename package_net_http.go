...
// a custom implementation of the writer interface that still prints out all the data
...
func main() {
	...
	printResponseBody_method3(response)
}
...
func printResponseBody_method3(response *http.Response) {
	/*
